...
ADD ttrss-auth-oidc-master.tar.gz /var/www/plugins.local/ttrss-auth-oidc-master.tar.gz
RUN mkdir auth_oidc
RUN pwd
RUN tar xzvpf ttrss-auth-oidc-master.tar.gz - --strip-components=1 -C auth_oidc
